<%-- 
    Document   : SeriesJSP
    Created on : 09/05/2016, 04:17:00 PM
    Author     : Alfredo
--%>
...
<html>
    ...
    <body>
        ...
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img src="imagenes/categoria/.jpg" alt="logo"/>
            <p><a href="Serie_Cat_accionJSP.jsp">Acción</a></p>
        </div>
        
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img  src="imagenes/categoria/.jpg.jpg" alt="logo" /> 
            <p><a href="Serie_Cat_aventuraJSP.jsp">Aventura</a></p>
        </div>
                    
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img  src="imagenes/categoria/.jpg" alt="logo" /> 
            <p ><a href="Serie_Cat_ficcionJSP.jsp">Ciencia ficción</a></p>
        </div>
        
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img  src="imagenes/categoria/.jpg" alt="logo" />           
            <p ><a href="Serie_Cat_comediaJSP.jsp">Cómicas</a></p>
        </div>
        
        
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img src="imagenes/categoria/.jpg" alt="logo" />           
            <p ><a href="Serie_Cat_dramaJSP.jsp">Drama</a></p>
        </div>
        
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img  src="imagenes/categoria/.jpg" alt="logo" />           
            <p ><a href="Serie_Cat_fantasiaJSP.jsp">Fantasia</a></p>
        </div>
        
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img  src="imagenes/categoria/.jpg" alt="logo" /> 
            <p ><a href="Serie_Cat_romanticaJSP.jsp">Románticas</a></p>
        </div>
        
             
        <div class="col-xs-6 col-sm-4 col-md-3">
            <img  src="imagenes/categoria/.jpg" alt="logo" />           
            <p ><a href="Serie_Cat_terrorJSP.jsp">Terror</a></p>
        </div>
        </div>
