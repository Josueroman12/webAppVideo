<%-- 
    ...
    Created on : 09/05/2016, 04:27:49 PM
    Author     : Alfredo
--%>
...
<html>
    ...
    <body>
        ...
        <div id="contenidoRegistro">
            <form>
                <div>
                  <label class="textos">Nombre: <span class="warning">*</span></label>
                  <input class="form-control" type="text" name="nombre" value="" maxlength="20" placeholder="Digite su nombre" required="required"/> 
                </div>
                
                <div>
                  <label class="textos">Apellidos: <span class="warning">*</span></label>
                  <input class="form-control" type="text" name="apellidos" value="" maxlength="20" placeholder="Digite sus apellidos" required="required"/> 
                </div>
                
                <div>
                  <label class="textos">Correo Electronico: <span class="warning">*</span></label>
                  <input class="form-control" type="text" name="correo" value="" maxlength="20" placeholder="Digite Correo electrónico" required="required"/> 
                </div>
                
                <div>
                  <label class="textos">Teléfono: <span class="warning">*</span></label>
                  <input class="form-control" type="text" name="celular" value="" maxlength="20" placeholder="Digite su Teléfono Celular" required="required"/> 
                </div>
                
                <div>
                    <label class="textos">Mensaje: <span class="warning">*</span></label>
                    <textarea class="form-control" name="mensaje" required="required" placeholder="" ></textarea> 
                </div>
                
                <input class="form-control" type="hidden" name="infoOculta" value="InfoOculta"/> <!-- campos de texto ocultos-->
